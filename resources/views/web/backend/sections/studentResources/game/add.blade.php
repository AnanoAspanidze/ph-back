...
@section('title', 'სავარჯიშოს გვერდის დამატება')

@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 col-md-10">
                <h4 class="m-0">სავარჯიშოს გვერდის დამატება</h4>
            </div>
        </div>
    </div>
@endsection
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 col-md-10 m-auto">
            ...
            <form role="form" method="post" action="{{route('game_page.store', $topic->id)}}">
            @csrf
            @include('web.backend.sections.studentResources.pagepartial', ['resources' => $topic->resources])
                <div class="card card-primary">
                    <div class="card-body">
                        ...
                        <div id="custom-game-wrapper"  style="display: {{ old('type') === 'code'  ? 'block' : 'none'  }}">
                            <div class="form-group">
                                <label for="code">სავარჯიშოს კოდი</label>
                                <textarea id="code" name="code" rows="8" cols="80">{!!old('code')!!}</textarea>
                                @error('code')
                                    <span class="help-error-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div id="test-wrapper" style="display: {{ old('type') === 'test'  ? 'block' : 'none'  }}">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="tinymce-editor" id="{{$language->locale.'-instruction'}}" name="{{$language->locale}}[instruction]" rows="8" cols="80">{!!old($language->locale.'.instruction')!!}</textarea>
