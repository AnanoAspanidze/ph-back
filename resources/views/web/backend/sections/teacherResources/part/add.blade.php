...
@section('title', 'ნაწილის დამატება')

@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 col-md-10">
                <h4 class="m-0">ნაწილის დამატება</h4>
            </div>
        </div>
    </div>
@endsection
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 col-md-10 m-auto">
            <form role="form" method="post" action="{{route('part.store', $course->id)}}">
            @csrf
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>აირჩიე, რომელი ნაწილის შემდეგ იყოს</label>
                            <select class="form-control" id="partsortselect" name="sort">
                                <option value="">პირველი</option>
                                @foreach($course->parts as $part)
                                    <option value="{{$part->sort ?? 0}}">{{$part->title}}</option>
                                @endforeach
                            </select>
                            @error('sort')
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="{{$language->locale.'-short_desc'}}" name="{{$language->locale}}[short_desc]" rows="8" cols="80">{!!old($language->locale.'.short_desc')!!}</textarea>
