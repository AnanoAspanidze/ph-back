    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 col-md-10">
                <h4 class="m-0"> {{$item->title ?? $item->short_desc}}  |   კითხვის დამატება</h4>
            </div>
        </div>
    </div>
@endsection
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 col-md-10 m-auto">
            ...
            <form role="form" method="post" action="{{route('teacher_resources.question.store', [$item->id, $type])}}">
            @csrf
                <div class="card card-primary">
                    <div class="card-body">
                        
                        <div class="form-group">
                            @php( $answerTypes = ['one' => 'ერთი პასუხი', 'many' => 'ბევრი პასუხი'] )
                        ...
                        <div class="form-group answers-select-container">
                            ...
                            <select 
                                ...
                                required
                                id="game-type"
                                @if(old('type') && old('type') !== 'one')
                                   multiple="multiple"
                                @endif>
                                    @for($i = 1; $i <= 4; $i++) {
                                        <option value="{{$i}}" @if (old('isRight') && in_array($i, old('isRight'))) selected="selected" @endif>პასყხი {{$i}}</option>
                                    @endfor
                            </select>
                            @error('isRight')
                                <span class="help-error-block">{{ $message }}</span>
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="{{$language->locale.'-purpose'}}" name="{{$language->locale}}[purpose]" value="{{old($language->locale.'.purpose')}}" placeholder="შეიყვანეთ კომენტარი">
                                    ...
                                    <div class="answers"> 
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="{{$language->locale.'-answer1'}}" name="answers[1][{{$language->locale}}][answer]" value="{{old('answers.1.'.$language->locale.'.answer')}}" placeholder="შეიყვანეთ პასუხი 1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="{{$language->locale.'-answer2'}}" name="answers[2][{{$language->locale}}][answer]" value="{{old('answers.2.'.$language->locale.'.answer')}}" placeholder="შეიყვანეთ პასუხი 2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="{{$language->locale.'-answer3'}}" name="answers[3][{{$language->locale}}][answer]" value="{{old('answers.3.'.$language->locale.'.answer')}}" placeholder="შეიყვანეთ პასუხი 3">                                            
                                        </div>

                                        <div class="form-group">
                                            <label for="{{$language->locale.'-answer4'}}">პასუხი 4 ({{$language->locale}})</label>
                                            <input type="text" class="form-control" id="{{$language->locale.'-answer4'}}" name="answers[4][{{$language->locale}}][answer]" value="{{old('answers.4.'.$language->locale.'.answer')}}" placeholder="შეიყვანეთ პასუხი 4">
                                        </div>
                                    </div>
                                </div>
                            </div>
