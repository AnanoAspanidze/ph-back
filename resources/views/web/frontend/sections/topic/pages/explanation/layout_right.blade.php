      ...
      <div class="row">
        <div class="col-12 col-lg-6 col-xl-5">
          @if($explanation->type === 'image')
            <div class="section__theme__page__img__container">
        ...
        <div class="col-12 col-lg-6 col-xl-7">
          <section class="section__description mt-mobile">
            <div class="row section__description__row">
              <div class="col-12 col-lg-2 col-xxl-12">
              ...
              <div class="col-12 col-lg-10 col-xxl-12">
                <div class="section__description__body paddings section__description__content">
                  <div class="row">
                    <div class="col-12 m-auto">
                      ...
                      <p class="section__theme__page__p mt-34 about__faq__text-light">
                        ...
                        <!-- <span class="moreText">
                          ლორემ იპსუმ რთავდნენ გადაუწყვიტეს დედაკაცები სამკუთხედი ინგლისურად გოჭმა
                          გამოსახულებას დანიშვნის დაესაჯა
                          სწორკუთხა გადამეკიდა გზაასაქცევი. ლუარსაბისა გაეპრანჭება ყვიროდნენ
                          განიკითხავს გადაუწყვიტეს გადამეკიდა
                          პირდაღვრემილია, დანიშვნის გარეუბნებს იტირებდა გასცემ კნიაზობა უცერემონიოდ
                          შეხვდებოდნენ.
                        </span> -->
                      </p>
                      <!-- <button class="readMoreBtn m-auto m-lg-0 header__nav__btn bt-blue">მაჩვენე მეტი
                        <svg class="icon">
